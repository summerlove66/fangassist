package com.huido.fangassist.config;
...
public class RedisConfig {
    ...
    @Bean
    RedisTemplate<String, House> newsRedisTemplate() {
        RedisTemplate<String, House> redisTemplate = new RedisTemplate<String, House>();
